            ...
            >
                ...
                <div className="px-6 py-4 bg-gray-50 rounded-b-lg flex justify-between">
                    ...
                    <button
                        onClick={performScan}
                        disabled={isScanning}
                        className="px-6 py-2 text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 disabled:bg-purple-400 rounded-md transition-colors flex items-center"
                    >
                        {isScanning ? (
                            <>
