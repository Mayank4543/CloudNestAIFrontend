                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center mb-2">
                                        <div className="flex-shrink-0 h-8 w-8 bg-[#f5e6e6] text-[#b21818] rounded flex items-center justify-center mr-3">
                                            {getFileIcon(file.mimetype)}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                    ...
                                    <div className="mb-1 text-xs text-gray-500">
                                        Deleted on: {formatDateShort(file.deletedAt || file.updatedAt)}
                                    </div>
                                    ...
                                    <div className="flex items-center text-xs text-gray-500">
                                        <span>{file.size && file.size > 0 ? formatFileSize(file.size) : 'N/A'}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex space-x-2">
                                    <button
                                        ...
                                        className="p-2 text-green-600 rounded hover:bg-green-50 transition-colors"
                                        title="Restore"
                                    >
